...
public class LetterSaadAnimator : MonoBehaviour
{
    private float animationDuration = 20.0f;

    private LineRenderer lineRenderer, secondSlashRenderer, thirdSlashRenderer, 
        fourthSlashRenderer, fifthSlashRenderer, sixthSlashRenderer, seventhSlashRenderer;
    private Vector3[] linePoints;
    private int pointsCount;
    public GameObject secondSlash, thirdSlash, fourthSlash, fifthSlash, sixthSlash, seventhSlash;
